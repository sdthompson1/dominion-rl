...
class DQNAgent:
    ...
    # Train the agent
    def train(self, num_episodes, print_freq):
        total_reward = 0.0
        total_steps = 0
        sample_game_counter = 0
        ...
        for episode in range(num_episodes):
            ...
            if (episode + 1) % print_freq == 0:
                ...
                sample_game_counter += 1
                if sample_game_counter % 5 == 0:
                    self.run_sample_games(500)
    ...
    def run_sample_games(self, num_games):
        ...
        # Print results
        print(f"Average score: {total_reward / num_games:.2f}")
